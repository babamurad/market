...
<main class="main--wrapper">
    ...
    <section class="hero hero__area">
        <div class="hero__active slider-active">
            <div class="single__hero single-slider hero__bg pt-140 pb-120" data-background="{{ asset('assets/front/img/bg/h1__hero__bg.png') }}">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-9 offset-lg-3">
                            <div class="hero__caption">
                                ...
                                <p class="product--price__hero white-color mb-20" data-animation="fadeInLeft" data-delay=".7s"><span class="f-300">Wide Rang Start From</span><span class="price f-800"><sup>$</sup>252.00</span></p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="offer-banner offer--banner__bg mb-30" data-background="{{asset('assets/front/img/offer/offer__thumb__2.jpg')}}">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="offer-banner offer--banner__bg mb-30" data-background="{{asset('assets/front/img/offer/offer__thumb__1.jpg')}}">
                        <div class="offer--banner__text">
                                ...
                                <div class="product__active owl-carousel">
                                        ...
                                        <div class="product__box">
                                            <div class="product__thumb">
                                                <a href="product-details.html" class="img-wrapper">
                                                    ...
                                                    <img class="img secondary-img" src="{{ asset('assets/front/img/allproducts/products__thumb__02.jpg') }}" alt="">
                                                </a>
                                            </div>
                                    ...
                                    <div class="product__single">
                                        <div class="product__box">
                                            <div class="product__thumb">
                                                <a href="product-details.html" class="img-wrapper">
                                                    <img class="img" src="{{ asset('assets/front/img/allproducts/products__thumb__02.jpg') }}" alt="">
                                                    <img class="img secondary-img" src="{{ asset('assets/front/img/allproducts/products__thumb__04.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="product__content--top">
                                                <span class="cate-name">SAMSUNG</span>
                ...
                <div class="col-xl-10">
                    <div class="categories-active row position-relative">
                        <div class="single-categories col-sm-12">
                            <div class="categories-box position-relative">
                                <div class="categories-thumb">
                                    <a href="#"><img class="img" src="{{ asset('assets/front/img/categories/cate__thumb1.jpg') }}" alt=""></a>
                        ...
                        <div class="single-categories col-sm-12">
                            <div class="categories-box position-relative">
                                <div class="categories-thumb">
                                    <a href="#"><img class="img" src="{{ asset('assets/front/img/categories/cate__thumb2.jpg') }}" alt=""></a>
                        ...
                        <div class="single-categories col-sm-12">
                            <div class="categories-box position-relative">
                                <div class="categories-thumb">
                                    <a href="#"><img class="img" src="{{ asset('assets/front/img/categories/cate__thumb3.jpg') }}" alt=""></a>
                        ...
                        <div class="single-categories col-sm-12">
                            <div class="categories-box position-relative">
                                <div class="categories-thumb">
                                    <a href="#"><img class="img" src="{{ asset('assets/front/img/categories/cate__thumb4.jpg') }}" alt=""></a>
    ...
    <div class="offer-deals">
        <div class="offer--deals__main offer-deals--bg pt-75 pb-45" data-background="{{ asset('assets/front/img/bg/offer__deals__bg.png') }}">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-xl-4 col-lg-4">
                                            <div class="offer--deals__title mb-30">
                                                <h2>Limited <span class="f-800 pure__black-color d-block">Weekly Deals</span></h2>
                                        ...
                                        <div class="col-xl-4 offset-xl-4 col-lg-6 offset-lg-2">
                                            <div class="offer--deals__products mb-30">
                                                ...
                                                <div class="products--deals__content mb-35">
                                                    <h6 class="f-700 mb-20"><a href="#">3D Wooden Ceiling Floor Lighting For
                                                            Living Room</a></h6>
                                                ...
                                                <div class="product-countdown mb-15">
                                                    <div class="time-count-deal">
                                                        <div class="countdown-list" data-countdown="2019/12/01"></div>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="deals--nav__menu">
                            <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Gaming Console & Control</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Smart Watches Deal Series 2</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="computer-tab" data-toggle="tab" href="#computer" role="tab" aria-selected="false">Computer & TVs</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="watch-tab" data-toggle="tab" href="#watch" role="tab" aria-selected="false">Smart Watches Deal Series 2</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="product pt-60 fix">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="offer-banner offer--banner__bg mb-30" data-background="{{ asset('assets/front/img/offer/offer__thumb__3.jpg') }}">
                        <div class="offer--banner__text">
                ...
                <div class="col-lg-6">
                    <div class="offer-banner offer--banner__bg mb-30" data-background="{{ asset('assets/front/img/offer/offer__thumb__4.jpg') }}">
                        <div class="offer--banner__text">
            ...
            <div class="row">
                    ...
                    <div class="product__single mb-30">
                        <div class="product__box featured__box--item">
                            ...
                            <div class="product--flex__right">
                                <div class="product__content--top">
                                    <span class="cate-name">SAMSUNG</span>
                                    <h6 class="product__title mine__shaft-color f-700 mb-30"><a href="product-details.html">Wireless Audioing
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product__single mb-30">
                        <div class="product__box featured__box--item">
                            <div class="product__thumb">
                                <a href="product-details.html"><img class="img" src="{{ asset('assets/front/img/allproducts/products__thumb__13.jpg') }}" alt=""></a>
                            </div>
                            <div class="product--flex__right">
                                <div class="product__content--top">
                                    <span class="cate-name">SAMSUNG</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product__single mb-30">
                        <div class="product__box featured__box--item">
                            <div class="product__thumb">
                                <a href="product-details.html"><img class="img" src="{{ asset('assets/front/img/allproducts/products__thumb__15.jpg') }}" alt=""></a>
                            </div>
                            <div class="product--flex__right">
                                <div class="product__content--top">
                                    <span class="cate-name">SAMSUNG</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product__single mb-30">
                        <div class="product__box featured__box--item">
                            <div class="product__thumb">
                                <a href="product-details.html"><img class="img" src="{{ asset('assets/front/img/allproducts/products__thumb__12.jpg') }}" alt=""></a>
                            </div>
                            <div class="product--flex__right">
                                <div class="product__content--top">
                                    <span class="cate-name">SAMSUNG</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product__single mb-30">
                        <div class="product__box featured__box--item">
                            <div class="product__thumb">
                                <a href="product-details.html"><img class="img" src="{{ asset('assets/front/img/allproducts/products__thumb__14.jpg') }}" alt=""></a>
                            </div>
                            <div class="product--flex__right">
                                <div class="product__content--top">
                                    <span class="cate-name">SAMSUNG</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product__single mb-30">
                        <div class="product__box featured__box--item">
                            <div class="product__thumb">
                                <a href="product-details.html"><img class="img" src="{{ asset('assets/front/img/allproducts/products__thumb__16.jpg') }}" alt=""></a>
                            </div>
                            <div class="product--flex__right">
                                <div class="product__content--top">
                                    <span class="cate-name">SAMSUNG</span>
                ...
                <div class="col-sm-12">
                    <div class="offer-banner offer--banner__bg bg-one mb-30 mt-25">
                        <a href="#">
                            <img src="{{ asset('assets/front/img/offer/offer__thumb__5.jpg') }}" class="img-fluid" alt="">
                ...
                <div class="col-xl-3 d-none d-xl-block">
                    <div class="small__banner mb-30">
                        <div class="small__banner--thumb position-relative">
                            <a href="#"><img src="{{ asset('assets/front/img/offer/offer__small__thumb1.jpg') }}" alt=""></a>
                    ...
                    <div class="product__active--small owl-carousel mb-30">
                        ...
                        <div class="product__single">
                            <div class="product__box">
                                <div class="product__thumb">
                                    <a href="product-details.html" class="img-wrapper">
                                        <img class="img" src="{{ asset('assets/front/img/allproducts/products__thumb__03.jpg') }}" alt="">
                                        <img class="img secondary-img" src="{{ asset('assets/front/img/allproducts/products__thumb__06.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="product__content--top">
                                    <span class="cate-name">SAMSUNG</span>
                ...
                <div class="col-sm-12">
                    <div class="brand-active">
                        <div class="single-brand">
                            <img src="{{ asset('assets/front/img/brand/brand-logo1.png') }}" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="{{ asset('assets/front/img/brand/brand-logo2.png') }}" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="{{ asset('assets/front/img/brand/brand-logo3.png') }}" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="{{ asset('assets/front/img/brand/brand-logo4.png') }}" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="{{ asset('assets/front/img/brand/brand-logo5.png') }}" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="{{ asset('assets/front/img/brand/brand-logo2.png') }}" alt="">
                        </div>
                    ...
                    <div class="newsletter newsletter--box d-flex justify-content-between align-items-center pos-rel">
                        <div class="left d-flex justify-content-between align-items-center">
                            <div class="newsletter__title">
                                <span class="notification--icon"><img src="{{ asset('assets/front/img/icon/notification-icon.png') }}" alt="notification"></span>
                        ...
                        <form class="right newsletter--form pos-rel">
                            ...
                            <button class="btn newsletter--button" type="button"><img src="{{ asset('assets/front/img/icon/plan-icon.png') }}" alt=""></button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <div class="modal-wrapper">
                       <div class="pro-img">
                           <img src="{{ asset('assets/front/img/allproducts/modal-img.jpg') }}" data-zoom-image="{{ asset('assets/front/img/allproducts/demo.jpg') }}" class="zoom-e-img" alt="">
                       </div>
                       <div class="pro-text">
